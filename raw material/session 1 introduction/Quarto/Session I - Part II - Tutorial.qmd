---
title: "Part II: Foundations of Bayesian Network Analysis"
...
📘 Session I - Part I — Foundations of Bayesian Network Analysis ✅  
🔧 **Session I - Part II — Practical Tutorial (this lecture)**
:::
...
In **Part I**, we explored how **Bayesian reasoning** helps distinguish *evidence of absence* from *absence of evidence*—showing how Bayes factors quantify support for or against network connections.  

Now, in **Part II**, we’ll put these ideas into practice. You’ll learn how to estimate Bayesian network models in **R** and **JASP**, interpret edge evidence, and understand how prior assumptions and uncertainty shape your conclusions.
...
::: {.goals}
- Fit Bayesian network models using `easybgm` or `JASP`  
...
```r
data = read.csv("https://raw.githubusercontent.com/Bayesian-Graphical-Modelling-Lab/BGM_Workshops/refs/heads/5thFSoIM/data/exampledata.csv")[, -1]
head(data)
```
...
![](figures/easybgm_run_edgeevidenceplot.png){fig-align="center" width=50%}
...
```
![](figures/easybgm_run_split.png){fig-align="center" width=100%}
...
![](figures/easybgm_run_networkplot.png){fig-align="center" width=50%}
...
![](figures/easybgm_run_ugly.png){fig-align="center" width=50%}
...
![](figures/easybgm_run_hdi.png){fig-align="center" width=50%}
...
![](figures/easybgm_run_centrality.png){fig-align="center" width=50%}
...
fit <- easybgm(
  ...
  type = "ordinal",
  package = "bgms",
  iter = 1e3, # bgms performs 4 chains (runs) with "iter" iterations in parallel
...
--- 
AGGREGATED EDGE OVERVIEW 
Number of edges with sufficient evidence for inclusion: 33 
Number of edges with insufficient evidence: 11 
...
--- 
STRUCTURE OVERVIEW 
Number of visited structures: 151 
Number of possible structures: 3.518437e+13 
Posterior probability of most likely structure: 0.136 
---
```
...
--- 
STRUCTURE OVERVIEW 
Number of visited structures: 140 
Number of possible structures: 3.518437e+13 
Posterior probability of most likely structure: 0.309 
---
```
...
![](figures/easybgm_run_sensitivity.png){fig-align="center" width=100%}
