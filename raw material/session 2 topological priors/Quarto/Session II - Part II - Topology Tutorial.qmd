...
## Part IV — Prior models of network topology
...
- **Interpret** posterior results in light of prior assumptions, with particular attention to:  
  ...
  – how the SBM prior can reveal clusters, and  
...
We now turn to an empirical example from [Martarelli, Ballifard, and Audrin (2023)](https://github.com/Bayesian-Graphical-Modelling-Lab/BGM_Workshops/blob/5thFSoIM/sessions/session%202%20topological%20priors/Martarelli%20Ballifard%20Audrin%202023.pdf).  
...
Your task is to test the clustering hypotheses from Martarelli, Ballifard, and Audrin (2023) using the Bayesian SBM.
...
4. **Compute clustering Bayes factors:**  
   Start by testing whether the data support clustering at all:  
   ...
   *Goal: first establish whether clustering is present, then evaluate whether the expected three-domain structure is supported over two domains.*
