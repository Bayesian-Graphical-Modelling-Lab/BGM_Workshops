...
This prior is available both fdor estimating networks based on ordinal/binary data as well as for estimating GGMs and models for mixed data

### The uniform Bernoulli prior
