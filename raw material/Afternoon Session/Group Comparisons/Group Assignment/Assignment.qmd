...
However, the authors did not investigate whether the estimated network structure differs between female and male participants.
...
## Inference (this is adjusted text for the mornign group assignment)
