...
The Beta-Bernoulli prior corrects for multiple testing. This is known as **multiplicity correction**.  
...
By contrast, the Beta–Bernoulli prior automatically adjusts the odds for edge inclusion, so that the evidence required for edge inclusion scales with the number of possible edges in the network.
