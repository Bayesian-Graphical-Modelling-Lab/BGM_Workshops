...
#| warning: false
#| include: false
fit <- easybgm(data[, -c(1,2)], type = "ordinal", edge_prior = "Stochastic-Block", update_method = "adaptive-metropolis", beta_bernoulli_alpha = 2, beta_bernoulli_beta = 1, beta_bernoulli_alpha_between = 1, beta_bernoulli_beta_between = 2, lambda = 1.59)
